```
abaelm:casper-sdk reviewer$ ./gradlew build
...
DeploySerializationTest > deploySerialization() PASSED
...
CasperDeployServiceTests > testDeployTransferOnTestnet() PASSED
...
-----------------------------------------------------------------
|  Results: SUCCESS (89 tests, 89 passed, 0 failed, 0 skipped)  |
-----------------------------------------------------------------
```