...
1- Install Ruby on Rails on a Ubuntu 20.04 cloud server (https://www.digitalocean.com/community/tutorials/how-to-install-ruby-on-rails-with-rbenv-on-ubuntu-20-04)

2- Install all the required ruby dependencies (gems) required by the SDK
...
3-Install and build casper_network0.2.0 gem from repository
